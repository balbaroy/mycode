...
upload_content = [
  ...
  { content = "C is for cookie! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "Danger, Will Robinson! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
